  ...
  */
  ...
  Milk.MoonLevel = (function(_super) {
    ...
    function MoonLevel() {
      ...
      this.players = {};
      this.player = new Milk.Alien(Milk.OverheadText, Milk.Animation, Milk.Movable, Milk.Controllable, Milk.Network);
    ...
    MoonLevel.prototype.receiveMessage = function(data) {
      ...
      return speak.play(message, {}, function() {
  ...
  Milk.NetworkChat = (function(_super) {
    ...
    NetworkChat.prototype.receiveMessage = function(data) {
      ...
      li.addEventListener('click', (function() {
        return game.level.receiveMessage(data);
      }), false);
      ul.appendChild(li);
      li = document.createElement('li');
      li.innerHTML = '&nbsp;';
