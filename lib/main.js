...
(function() {
  ...
  window.Milk = (function() {
    ...
    proxyToObject3D = function(key) {
      return function() {
        var _ref;
        return (_ref = this.object3D) != null ? _ref[key] : void 0;
      };
    };

    Milk.prototype.position = proxyToObject3D('position');
  ...
  */
  ...
  Milk.Movable = (function(_super) {
    ...
    Movable.prototype.exportObject = function(object) {
      return object.useQuaternion = true;
    };
  ...
  Milk.Controllable = (function(_super) {
    ...
    Controllable.prototype.update = function() {
      ...
      if (Milk.KeyHandler.isDown('right')) {
        return typeof this.turn === "function" ? this.turn(-1) : void 0;
      }
    };
  ...
  */
  ...
  Milk.MoonLevel = (function(_super) {
    ...
    function MoonLevel() {
      ...
      this.player = new Milk.Spaceman(Milk.Movable, Milk.Controllable, Milk.Jumpable);
    }
  ...
  Milk.Spaceman = (function(_super) {
    ...
    function Spaceman() {
      ...
      this.sprite = new Milk.Sprite("public/robot.png", function() {
        return _this.exportObject(_this.sprite.object3D);
      });
    }

    Spaceman.prototype.stage = function() {
      Spaceman.__super__.stage.apply(this, arguments);
      return this.scene.add(this.sprite.object3D);
    };
