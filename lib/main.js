...
(function() {
  ...
  Scene = (function() {
    ...
    Scene.prototype.render = function(time) {
      var delta, mapHeightAtCamera, mapHeightAtPlayer, player, target, timestep, vehicle, _, _i, _len, _ref, _ref1;
      if (!this.player) {
        return;
      }
  ...
  Player = (function(_super) {
    ...
    Player.prototype.afterUpdate = function() {
      var _ref;
      return (_ref = this.textObject) != null ? _ref.positionOver(this) : void 0;
    };
    ...
    Player.prototype.displayMessage = function(message) {
      ...
      this.textObject = new TextObject(message);
      return game.add(this.textObject);
    };

    Player.prototype.clearMessage = function() {
      return game.remove(this.textObject);
    };
  ...
  window.TextObject = (function(_super) {
    ...
    TextObject.prototype.positionOver = function(object) {
      ...
      this.position.y = object.position.y + (((_ref = object.boundingBox) != null ? _ref.max.y : void 0) || 0) + 1.3;
  ...
  Vehicle.Tardis = (function(_super) {
    ...
    Tardis.prototype.update = function() {
      if (game.player.position.distanceToSquared(this.position) < 75) {
