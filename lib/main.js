...
(function() {
  ...
  Scene = (function() {
    ...
    Scene.prototype.exitVehicle = function() {
      var vehicle;
      if (this.player.playerId) {
        return;
      }
      window.tardis = this.player;
      vehicle = this.player;
      vehicle.exit(vehicle.player);
      this.player = vehicle.player;
      return this.players[this.player.playerId] = this.player;
    };
  ...
  window.Vehicle = (function(_super) {
    ...
    Vehicle.prototype.enter = function(player) {
      ...
      if (!this.backgroundAudio) {
        this.backgroundAudio = audio = document.createElement('audio');
    ...
    Vehicle.prototype.exit = function(player) {
      this.hasEntered = false;
      this.backgroundAudio.pause();
      this.remove(player);
      player.position.x = this.position.x + 5;
      player.position.y = this.position.y;
      player.position.z = this.position.z + 5;
      game.add(player);
      return console.log(this.position.y);
    };
