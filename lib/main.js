(function() {
    ...
    function Client(game) {
      ...
      now.updatePlayer = __bind(function(player) {
        ...
        if (this.game.players[player.id]) {
          ...
          return this.game.players[player.id].position.z = player.position.z;
        }
      }, this);
  ...
  Scene = (function() {
    ...
    function Scene() {
      ...
      this.tardis.position = new THREE.Vector3(25, 9, -60);
  ...
  Player = (function() {
    ...
    Player.prototype.displayMessage = function(message) {
      ...
      mesh.position.y = 1.1;
      this.add(mesh);
      return this.clearMessageTimeout = setTimeout((__bind(function() {
        return this.clearMessage();
      }, this)), Math.max(message.length * 200, 1000));
    };
