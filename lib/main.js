(function() {
  ...
  Client = (function() {
    ...
    function Client(game) {
      this.game = game;
      now.addPlayer = __bind(function(id) {
        console.log("PLAYER ADDED!!!!");
        this.game.addPlayer(id, this.id() === id);
        return console.log("I AM " + (this.id()));
      }, this);
  ...
  Scene = (function() {
    ...
    function Scene() {
      ...
      var aspect, far, fov, geometry, material, near, skyMaterial, skyShader, skyTexture, urls, x;
    ...
    Scene.prototype.addPlayer = function(id, currentPlayer) {
      var p;
  ...
  Moon = (function() {
    ...
    Moon.prototype.getHeightData = function(img) {
      var canvas, context, data, imgd, j, pix, size;
