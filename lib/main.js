...
(function() {
  ...
  */
  ...
  Milk.Alien = (function(_super) {
    ...
    Alien.prototype.stage = function() {
      Alien.__super__.stage.apply(this, arguments);
  ...
  */
  ...
  Milk.MoonLevel = (function(_super) {
    ...
    function MoonLevel() {
      ...
      this.players = {};
      this.player = new Milk.Alien(Milk.Animation, Milk.Movable, Milk.Controllable, Milk.Network);
