...
(function() {
  ...
  Client = (function() {
    ...
    function Client(game) {
      var _this = this;
      this.game = game;
      now.addPlayer = function(id) {
        console.log("PLAYER ADDED!!!!");
        _this.game.addPlayer(id, _this.id() === id);
        return console.log("I AM " + (_this.id()));
      };
      now.updatePlayer = function(player) {
        ...
        if (_this.game.players[player.id]) {
          ...
          _this.game.players[player.id].position.z = player.position.z;
          return window.player = _this.game.players[player.id];
        }
      };
